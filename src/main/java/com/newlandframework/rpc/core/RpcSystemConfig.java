...
public class RpcSystemConfig {
	...
	// 服务器超时时间
	public static final long SYSTEM_PROPERTY_MESSAGE_CALLBACK_TIMEOUT = Long.getLong("nettyrpc.default.msg.timeout",
			30 * 1000L);
	...
	public static final int SYSTEM_PROPERTY_CLIENT_RECONNECT_DELAY = Integer
			.parseInt(System.getProperty("nettyrpc.default.client.reconnect.delay", "10"));
	...
	public static final int SYSTEM_PROPERTY_JMX_METRICS_HASH_NUMS = Integer.getInteger("nettyrpc.jmx.metrics.hash.nums",
			8);
	public static final int SYSTEM_PROPERTY_JMX_METRICS_LOCK_FAIR = Integer.getInteger("nettyrpc.jmx.metrics.lock.fair",
			0);
